 ...
 *
 * This file is used when building Python projects with pyproject.toml.
 * It extracts an embedded zip bundle containing the project code and
 * dependencies, then runs the entry module.
 *
